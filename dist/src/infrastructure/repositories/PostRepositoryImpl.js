...
class PostRepositoryImpl {
    ...
    toEntityPost(post) {
        ...
        const dbPost = this.postRepository.create(Object.assign(Object.assign(Object.assign(Object.assign({}, (post.id && { postId: post.id })), (post.authorId && { author: { userId: post.authorId } })), { title: post.title, subtitle: post.subtitle, platform: post.platform, contents: post.contents, status: postStatus, period: post.period, createdAt: post.createdAt ? post.createdAt : new Date(), updatedAt: post.updatedAt ? post.updatedAt : new Date() }), (post.appilcations && { applications: post.appilcations.map(appId => ({ appId })) })));
        return dbPost;
    }
    createPost(post) {
