...
exports.AutoGen1754747488245 = void 0;
class AutoGen1754747488245 {
    constructor() {
        this.name = 'AutoGen1754747488245';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.query(`ALTER TABLE \`User\` ADD \`role\` enum ('PROGRAMMER', 'DESIGNER', 'PUBLISHER', 'PLANNER', 'MANAGER', 'MARKETER', 'PM', 'QA', 'CS') NOT NULL`);
...
exports.AutoGen1754747488245 = AutoGen1754747488245;
