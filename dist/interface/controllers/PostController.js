...
class PostController {
    ...
    //     }
    // }
    getInitPosts(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const posts = yield this.postUseCase.getInitPosts();
    ...
    getWebPosts(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const webPosts = yield this.postUseCase.getWebPostsPaginations(page);
    ...
    getMobilePosts(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const page = parseInt(req.query.page) || 1;
                const mobilePosts = yield this.postUseCase.getMobilePostsPaginations(page);
