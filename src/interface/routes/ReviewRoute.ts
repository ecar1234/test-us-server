...
route.get('/getReviewById/:reviewId', reviewController.createReview.bind(reviewController));
...
// route.post('/getUserReviewAverage/', reviewController.getUserReviewAverage.bind(reviewController));
